...
export function Home() {
  ...
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative min-h-[95vh] flex items-center pt-20 pb-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <motion.div 
                ...
                className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-landrify-green/10 border border-landrify-green/20 mb-10"
              >
                <Sparkles className="w-4 h-4 text-landrify-green" strokeWidth={1.5} />
              ...
              <p className="text-xl text-gray-600 font-light max-w-lg mb-14 leading-relaxed">
                The most advanced land verification platform in Nigeria. We use satellite AI and legal data to protect your real estate investments with precision.
              </p>

              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8">
                <Link to="/register">
                  <Button className="w-full sm:w-auto h-20 px-14 text-xl group rounded-[2rem] shadow-2xl shadow-landrify-green/20">
                    Verify a Plot
                    <ArrowRight className="ml-3 w-6 h-6 group-hover:translate-x-1 transition-transform" strokeWidth={1.5} />
                  </Button>
                </Link>
                <Link to="/how-it-works">
                  <Button variant="outline" className="w-full sm:w-auto h-20 px-14 text-xl rounded-[2rem] border-landrify-line text-landrify-ink hover:bg-white">
                    Learn More
                  </Button>
                </Link>
              </div>
            ...
            >
              <div className="relative z-10 glass-card p-3 rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.1)] overflow-hidden border-white/60">
                <div className="relative rounded-[2.5rem] overflow-hidden aspect-[4/5]">
                  ...
                  <div className="absolute top-8 left-8 right-8 flex justify-between items-start">
                    <motion.div 
                      ...
                      className="glass-card px-5 py-3 rounded-2xl border-white/30 backdrop-blur-md"
                    >
                      <p className="col-header text-white/70 mb-1">Coordinates</p>
                      <p className="data-value text-sm text-white">6.4531° N, 3.3958° E</p>
                    </motion.div>
                    <motion.div 
                      whileHover={{ rotate: 15 }}
                      className="w-14 h-14 bg-landrify-green rounded-2xl flex items-center justify-center shadow-xl"
                    >
                      <ShieldCheck className="text-white w-7 h-7" strokeWidth={1.5} />
                    </motion.div>
                  </div>

                  <div className="absolute bottom-8 left-8 right-8 glass-card p-8 rounded-3xl border-white/30 backdrop-blur-2xl">
                    <div className="flex items-center justify-between mb-5">
                      <div>
                        <p className="col-header text-white/70 mb-1">Status</p>
                        <p className="text-xl font-bold text-white">Verified Secure</p>
                      </div>
                      <div className="text-right">
                        <p className="col-header text-white/70 mb-1">Risk Score</p>
                        <p className="text-xl font-bold text-landrify-green">98/100</p>
                      </div>
                    </div>
                    <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                      <motion.div 
                        ...
                        className="h-full bg-landrify-green shadow-[0_0_15px_rgba(0,255,159,0.5)]"
                      />
                    </div>
                  </div>
                </div>
              ...
              <motion.div 
                ...
                className="absolute -right-12 top-1/4 glass-card p-5 rounded-2xl shadow-2xl border-white/40 z-20 hidden lg:block"
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="col-header text-gray-400 mb-0.5">Location</p>
                    <p className="text-sm font-bold text-landrify-ink">Lekki Phase 1</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute -left-16 bottom-1/4 glass-card p-5 rounded-2xl shadow-2xl border-white/40 z-20 hidden lg:block"
              >
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-landrify-orange/10 rounded-xl flex items-center justify-center text-landrify-orange">
                    <Lock size={20} strokeWidth={1.5} />
                  </div>
                  <div>
                    <p className="col-header text-gray-400 mb-0.5">Security</p>
                    <p className="text-sm font-bold text-landrify-ink">Encrypted</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
          ...
          >
            ...
            <Link to="/register">
              <Button className="bg-white text-landrify-green-dark hover:bg-gray-100 h-20 px-16 text-xl shadow-2xl rounded-[2rem] transition-transform active:scale-95">
                Get Started Now
              </Button>
            </Link>
          </motion.div>
